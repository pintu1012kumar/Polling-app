...
export default function ModeratePollsPage() {
  ...
  const [editPollModalOpen, setEditPollModalOpen] = useState(false) // Renamed for clarity
  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      // Only allow 'moderator' role to proceed, otherwise redirect to '/polls'
  ...
  // This function is for editing polls only now
  const handleSavePoll = async () => {
    ...
    if (!editingId) {
        showAlert("Error", "Cannot create new polls. You can only edit existing ones.", "destructive");
        return;
    }
    ...
    // The logic here is for UPDATING only
  ...
  const handleEditPoll = (poll: Poll) => {
    ...
    setEditPollModalOpen(true) // Open the modal for editing
  }
  ...
  const resetForm = () => {
    ...
    setEditPollModalOpen(false) // Close the modal
  }
      ...
      <div className="flex justify-center items-center h-screen">
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="text-center">
            <h3 className="text-lg font-semibold">Loading Moderator Panel</h3>
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="space-y-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-1">Edit and delete all created polls</p>
            </div>
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-20">
                ...
                <p className="text-muted-foreground text-center max-w-md">
                  There are no polls to moderate at this time.
                </p>
              </CardContent>
            </Card>
          )}
      ...
      <Dialog open={editPollModalOpen} onOpenChange={setEditPollModalOpen}>
          ...
          <DialogHeader className="space-y-3">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <DialogDescription>Make changes to the poll details</DialogDescription>
              </div>
            </div>
          </DialogHeader>
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-3">
              ...
              <p className="text-sm flex justify-between text-muted-foreground">
                <span>Edit your poll question</span>
