...
import PollComments from '../../components/PollComments' // Import PollComments component
...
export default function ModeratePollsPage() {
  ...
  const handleSavePoll = async () => {
    ...
    if (editingId) {
      ...
      // Moderators cannot create new polls, so we'll just log an error or show an alert.
      showAlert("Error", "Moderators cannot create new polls.", "destructive");
    }
